...
ice_rerewhakaaitu <- data.frame(Lake = LAKE,
                  Season = "Open water",
                  Method = "Ice",
                  start = 0,
                  end = 365) %>%
...
ice_mohonk <- data.frame(Lake = c(LAKE, LAKE),
...
ice_erken <- data.frame(start = c(0, inspect$start, inspect$end),
...
ice_arendsee <- data.frame(Lake = c(LAKE),
                  Season = c("Open water"),
                  Method = c("Ice"),
                  start = c(0),
                  end = c(365)) %>%
...
ice_batur <- data.frame(Lake = LAKE,
                  Season = "Open water",
                  Method = "Ice",
                  start = 0,
                  end = 365) %>%
...
ice_tanganyika <- data.frame(Lake = LAKE,
                  Season = "Open water",
                  Method = "Ice",
                  start = 0,
                  end = 365) %>%

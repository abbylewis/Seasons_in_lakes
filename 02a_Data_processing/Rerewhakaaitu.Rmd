...
```{r}
# Load data
in_lake_data <- read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/1312/6/f8e0e7b22826772424f156b9565d1498") %>%
...
```{r}
# Load data
met <- read_csv("https://pasta-s.lternet.edu/package/data/eml/edi/1312/4/e312838eff13f56594021498f35c04cd")

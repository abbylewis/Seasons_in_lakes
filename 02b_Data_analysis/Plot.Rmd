...
bvr_met_format <- read.csv("../01b_Processed_data/FCR_met.csv")
...
continuous <- continuous_data %>%
  ...
  scale_x_continuous(breaks = c(0, 91, 182, 273, 365),
                 labels = c("Winter solstice", "Spring equinox", 
...
as.Date("2022-06-21")-as.Date("2021-12-21")
```

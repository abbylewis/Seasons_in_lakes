...
```{r}
jpeg("../03a_Figures/Seasons_data.jpg", width = 9, height = 9, units = "in", res = 300)
ggarrange(discrete_strat, continuous, align = "h")
dev.off()

jpeg("../03a_Figures/Seasons_data_ice.jpg", width = 8.5, height = 8, units = "in", res = 300)
...
jpeg("../03a_Figures/Seasons_data_ice2.jpg", width = 10, height = 8, units = "in", res = 300)

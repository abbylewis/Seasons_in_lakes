...
strat <- read.csv("../01b_Processed_data/FCR_stratification_metrics.csv") %>%
...
```{r}
jpeg("../03a_Figures/Seasons_data.jpg", width = 6, height = 3.5, units = "in", res = 300)
ggarrange(discrete + ylab("FCR"), continuous, align = "h")
dev.off()

jpeg("../03a_Figures/Seasons_data2.jpg", width = 8, height = 3.5, units = "in", res = 300)

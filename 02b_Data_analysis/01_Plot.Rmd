...
lake_relabel <- function(lakes) {
  labels <- c(
    ...
    "Lake Batur (2023-2024)" = "bold('i)')~`Lake Batur (2023-2024); Z`[max]~`= 88 m`",
    "Lake Rerewhakaaitu (2022-2023)" = "bold('j)')~`Lake Rerewhakaaitu (2022-2023); Z`[max]~`= 15 m`",
    "West Lake Bonney (2023-2024)" = "bold('k)')~`West Lake Bonney (2023-2024); Z`[max]~`= 44 m`"
  )

...
sh_lakes <- c("Rerewhakaaitu", "West Lake Bonney (2023-2024)")
...
lake_relabel <- function(lakes){
  labels <- c(
    ...
    "Lake Rerewhakaaitu (2022-2023)" = "bold('i)')~`Lake Rerewhakaaitu (2022-2023); Z`[max]~`= 15 m`",
    "West Lake Bonney (2023-2024)" = "bold('j)')~`West Lake Bonney (2023-2024); Z`[max]~`= 40 m`"
  )

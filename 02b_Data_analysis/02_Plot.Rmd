...
lake_relabel <- function(lakes){
  labels <- c(
    ...
    "Kinneret (1993)" = "bold('h)')~`Kinneret (1993); Z`[max]~`= 43 m`",
    "Lake Tanganyika (2012-2013)" = "bold('i)')~`Lake Tanganyika (2012-2013); Z`[max]~`= 1470 m`",
    "Lake Batur (2022-2023)" = "bold('j)')~`Lake Batur (2022-2023); Z`[max]~`= 88 m`",
    "Lake Rerewhakaaitu (2022-2023)" = "bold('k)')~`Lake Rerewhakaaitu (2022-2023); Z`[max]~`= 15 m`",
    "West Lake Bonney (2023-2024)" = "bold('l)')~`West Lake Bonney (2023-2024); Z`[max]~`= 40 m`"
  )

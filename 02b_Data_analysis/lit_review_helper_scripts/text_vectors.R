...
filler_words <- c(
  ...
  "each", "per",
  "any", "given", "following",
  "subsequent", "during", "climatic", "seasonal", "holocene",
  "consecutive", "specific", "than", "certain", "contrasting",
  "previous", "other"
)

temporal_phases <- c(
  "early", "mid", "late", "time", "short", "long",
  "extended", "year", "longer", "2-year", "prolonged",
